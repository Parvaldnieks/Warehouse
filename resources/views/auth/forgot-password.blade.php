    ...
    <div class="bg-gray-900 p-8 max-w-md mx-auto rounded-md shadow-lg text-gray-300">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1 w-full bg-gray-800 border border-yellow-500 p-2 rounded-md text-gray-200" type="email" name="email" :value="old('email')" required autofocus />
